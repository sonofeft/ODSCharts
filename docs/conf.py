...
# -*- coding: utf-8 -*-
#
# ODSCharts documentation build configuration file, created by
...
target_file = os.path.join( up_one, 'odscharts','_version.py')
...
htmlhelp_basename = 'ODSChartsdoc'
...
latex_documents = [
  (master_doc, 'ODSCharts.tex', u'ODSCharts Documentation',
...
man_pages = [
    (master_doc, 'projectabcxyz', u'ODSCharts Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'ODSCharts', u'ODSCharts Documentation',
   author, 'ODSCharts', 'One line description of project.',
   'Miscellaneous'),
]
